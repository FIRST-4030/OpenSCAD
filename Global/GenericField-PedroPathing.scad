...
module labelWalls() {
    ...
    color("orange") {
        translate([FIELD_WIDTH/2-10,-FIELD_WIDTH/2+15,baseLevel]) 
            scale([FIELD_SCALE,FIELD_SCALE,1]) rotate([180,180,-270]) text("144,144", size=fontSize);
        translate([-FIELD_WIDTH/2+5,FIELD_WIDTH/2-5,5]) 
            scale([FIELD_SCALE,FIELD_SCALE,1]) rotate([180,180,-270]) text("0,0", size=fontSize);
        translate([FIELD_WIDTH/2-10,FIELD_WIDTH/2-10,baseLevel]) 
            scale([FIELD_SCALE,FIELD_SCALE,1]) rotate([180,180,-270]) text("0,144", size=fontSize);
        translate([-FIELD_WIDTH/2+10,-FIELD_WIDTH/2+15,baseLevel]) 
            scale([FIELD_SCALE,FIELD_SCALE,1]) rotate([180,180,-270]) text("144,0", size=fontSize);
    }
}
